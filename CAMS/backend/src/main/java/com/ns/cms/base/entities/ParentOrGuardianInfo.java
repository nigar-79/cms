...
@Entity
@Table(schema = "base", name = "parent_or_guardian_info")
public class ParentOrGuardianInfo extends BaseEntity {
	 ...
	 * 
	 */
	public ParentOrGuardianInfo() {
		super();
		// TODO Auto-generated constructor stub
	}

	/**
	 * @return the parentGuardianId
	 */
	...
	/**
	 * @param parentGuardianId the parentGuardianId to set
	 */
